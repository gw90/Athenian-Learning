...
$myUrl = 'http://www.gregorywickham.com/studygames/setdata.php';
...
echo "</ol>";
echo "<hr>";
echo file_get_contents("https://api.quizlet.com/2.0/sets/50113348/terms?client_id=Rrx8gXkBXT&whitespace=1");
/*
$curl = curl_init("https://api.quizlet.com/2.0/sets/50113348/terms/");
curl_setopt($curl, CURLOPT_HTTPHEADER, ['Authorization: Bearer '.$_SESSION['access_token']]);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
$data = json_decode(curl_exec($curl));
$responseCode = curl_getinfo($curl, CURLINFO_HTTP_CODE);
