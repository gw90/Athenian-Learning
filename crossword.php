...
<html lang="en">
  <head>
    ...
    <title>Crossword | Athenian Learning</title>
...
<div id="hmm"><?php echo file_get_contents("navbar.html");?></div>
		...
		<div class="container">
			...
			<div class="">
				...
				<h1 class="text-center">Crossword - Athenian Learning</h1>
 ...
 ?>
            ...
            <div class="col-sm-6">
                ...
                <div class="sliderContainer">
                    <input type="text" id="txtCrosswordTitle" value="<?php
...
echo $p1["title"];
  ...
  <script src="//code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <div id="hmm"><?php echo file_get_contents("footer.html");?>  <p>  The code for the crossword puzzle generator was made by Richard on GitHub</p></div>
  </body>
</html>